...
public class EventHandler {
    ...
    static final String MODEL_PATH = "src/main/resources/safehome_u75.mdp";
    static private final String JMDP_MODEL_PATH = "src/main/resources/safehome_u75.jmdp";
    static final String RECTANGLES_PATH = "src/main/resources/rectangles";

    static final int SAMPLE_SIZE = 1500;
